...
class beauty2Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    private fun populatingData(){
        ...
        arrayList.add(cardItemWithoutId(5, R.drawable.b10, "Beauty", 2, 3))
        arrayList.add(cardItemWithoutId(4, R.drawable.b9, "Cold Drink", 2, 3))
        arrayList.add(cardItemWithoutId(33, R.drawable.b6, "Biscuts", 2, 3))
        arrayList.add(cardItemWithoutId(42, R.drawable.b3, "Pizza", 2, 3))
        arrayList.add(cardItemWithoutId(51, R.drawable.b5, "Pizza", 2, 3))
        arrayList.add(cardItemWithoutId(62, R.drawable.b1, "Pizza", 2, 3))
        arrayList.add(cardItemWithoutId(62, R.drawable.b1, "Pizza", 2, 3))
        arrayList.add(cardItemWithoutId(62, R.drawable.b1, "Pizza", 2, 3))
        arrayList.add(cardItemWithoutId(62, R.drawable.b1, "Pizza", 2, 3))
        arrayList.add(cardItemWithoutId(62, R.drawable.b1, "Pizza", 2, 3))
