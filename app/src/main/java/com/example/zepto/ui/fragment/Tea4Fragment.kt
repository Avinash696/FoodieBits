...
class Tea4Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    private fun populatingData(){
        ...
        arrayList.add(cardItemModel(1, R.drawable.tea1, "All Tea", 2, 3))
        arrayList.add(cardItemModel(2, R.drawable.tea2, "Tea 1", 2, 3))
        arrayList.add(cardItemModel(3, R.drawable.tea3, "Tea 2", 2, 3))
        arrayList.add(cardItemModel(4, R.drawable.tea4, "Tea 3", 2, 3))
        arrayList.add(cardItemModel(5, R.drawable.tea6, "Tea 4", 2, 3))
