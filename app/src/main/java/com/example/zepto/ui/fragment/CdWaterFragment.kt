 ...
 * Use the [CdWaterFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CdWaterFragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cd_water, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvCdWaterFrag)
        populatingData()
