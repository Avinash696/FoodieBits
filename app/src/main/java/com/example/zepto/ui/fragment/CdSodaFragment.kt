 ...
 * Use the [CdSodaFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CdSodaFragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cd_soda, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvSoda)
        populatingData()
