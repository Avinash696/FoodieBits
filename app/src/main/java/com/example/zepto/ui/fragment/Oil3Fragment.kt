 ...
 * Use the [Oil3Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Oil3Fragment (val detailViewModel: DetailViewModel): Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_oil3, container, false)
    }

    private fun populatingData(){
        val arrayList = ArrayList<cardItemModel>()
        arrayList.add(cardItemModel(1, R.drawable.oil9, "All Green", 2, 3))
        arrayList.add(cardItemModel(2, R.drawable.oil5, "oil1", 2, 3))
        arrayList.add(cardItemModel(3, R.drawable.oil3, "oil2", 2, 3))
        arrayList.add(cardItemModel(4, R.drawable.oil2, "Green Tea 3", 2, 3))
        arrayList.add(cardItemModel(5, R.drawable.oil5, "Green Tea 4", 2, 3))
        arrayList.add(cardItemModel(6, R.drawable.oil6, "Green tea 5", 2, 3))
        arrayList.add(cardItemModel(6, R.drawable.oil6, "Green Tea 6", 2, 3))
