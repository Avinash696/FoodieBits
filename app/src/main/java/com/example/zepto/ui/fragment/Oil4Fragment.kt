 ...
 * Use the [Oil4Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Oil4Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_oil4, container, false)
    }

    private fun populatingData(){
        val arrayList = ArrayList<cardItemModel>()
        arrayList.add(cardItemModel(1, R.drawable.oil6, "All Green", 2, 3))
        arrayList.add(cardItemModel(2, R.drawable.oil10, "oil1", 2, 3))
