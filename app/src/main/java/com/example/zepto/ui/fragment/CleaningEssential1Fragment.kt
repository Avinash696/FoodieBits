 ...
 * Use the [CleaningEssential1Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CleaningEssential1Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cleaning_essential1, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvCE1)
        populatingData()
