 ...
 * Use the [CleaningEssentia4Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CleaningEssentia4Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cleaning_essentia4, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvCE4)
        populatingData()
