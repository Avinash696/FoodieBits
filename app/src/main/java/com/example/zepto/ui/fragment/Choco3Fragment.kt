 ...
 * Use the [Choco3Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Choco3Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_choco3, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvChoco3)
        populatingData()
