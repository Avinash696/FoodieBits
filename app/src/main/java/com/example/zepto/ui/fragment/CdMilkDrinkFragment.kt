 ...
 * Use the [CdMilkDrinkFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CdMilkDrinkFragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cd_milk_drink, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvCdMilk)
        populatingData()
