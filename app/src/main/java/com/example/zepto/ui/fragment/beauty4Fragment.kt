...
class beauty4Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    private fun populatingData(){
        ...
        arrayList.add(cardItemModel(1, R.drawable.b1, "Beauty", 2, 3))
        arrayList.add(cardItemModel(2, R.drawable.b2, "Cold Drink", 2, 3))
        arrayList.add(cardItemModel(3, R.drawable.b3, "Biscuts", 2, 3))
        arrayList.add(cardItemModel(4, R.drawable.b7, "Pizza", 2, 3))
        arrayList.add(cardItemModel(5, R.drawable.b8, "Pizza", 2, 3))
        arrayList.add(cardItemModel(6, R.drawable.b9, "Pizza", 2, 3))
        arrayList.add(cardItemModel(6, R.drawable.b9, "Pizza", 2, 3))
        arrayList.add(cardItemModel(6, R.drawable.b9, "Pizza", 2, 3))
        arrayList.add(cardItemModel(6, R.drawable.b9, "Pizza", 2, 3))
        arrayList.add(cardItemModel(6, R.drawable.b9, "Pizza", 2, 3))
