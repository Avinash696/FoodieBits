 ...
 * Use the [Choco2Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Choco2Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_choco2, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvChoco2)
        populatingData()
