...
//        changeFragment(MapsFragment(detailViewModel))
        ...
        //intent home name   === is empty
        val homeName = receiveIntent.getIntegerArrayListExtra("nameArrayKey")
//        for (i in 0 until homeName!!.size){
//            Log.d("myrules", "onCreate: ${homeName[i]}")
//        }
...
//        listAdapter = ArrayAdapter(this ,R.layout.detail_row,arr)
    ...
    private fun populatinDataFragment(data: Int) {
        binding.tvCartCountDetail.text = detailViewModel.count.toString()
        when (data) {
            1 -> {
                //my default layout
