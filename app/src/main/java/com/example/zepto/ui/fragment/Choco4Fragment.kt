 ...
 * Use the [Choco4Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Choco4Fragment (val detailViewModel: DetailViewModel): Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_choco4, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvChoco4)
        populatingData()
