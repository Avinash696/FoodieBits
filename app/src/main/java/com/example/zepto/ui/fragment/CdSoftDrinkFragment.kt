 ...
 * Use the [ColdDrink1Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ColdDrink1Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cold_drink1, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        simpleCategories = view.findViewById(R.id.gvCd1)
        populatingData()
