...
class Oil2Fragment (val detailViewModel: DetailViewModel): Fragment() {
    ...
    private fun populatingData(){
        ...
        arrayList.add(cardItemWithoutId(1, R.drawable.oil10, "All Green", 2, 3))
        arrayList.add(cardItemWithoutId(2, R.drawable.oil8, "oil1", 2, 3))
        arrayList.add(cardItemWithoutId(3, R.drawable.oil7, "oil2", 2, 3))
