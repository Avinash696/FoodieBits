 ...
 * Use the [Oil2Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Oil2Fragment (val detailViewModel: DetailViewModel): Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_oil2, container, false)
    }
    private fun populatingData(){
        val arrayList = ArrayList<cardItemModel>()
        arrayList.add(cardItemModel(1, R.drawable.oil10, "All Green", 2, 3))
        arrayList.add(cardItemModel(2, R.drawable.oil8, "oil1", 2, 3))
        arrayList.add(cardItemModel(3, R.drawable.oil7, "oil2", 2, 3))
