...
class Oil5Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    private fun populatingData(){
        ...
        arrayList.add(cardItemWithoutId(1, R.drawable.oil5, "All Green", 2, 3))
        arrayList.add(cardItemWithoutId(2, R.drawable.oil3, "oil1", 2, 3))
        arrayList.add(cardItemWithoutId(3, R.drawable.oil8, "oil2", 2, 3))
        arrayList.add(cardItemWithoutId(4, R.drawable.oil4, "Green Tea 3", 2, 3))
        arrayList.add(cardItemWithoutId(5, R.drawable.oil2, "Green Tea 4", 2, 3))
