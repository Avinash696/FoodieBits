...
class Sauce2Fragment(val detailViewModel: DetailViewModel) : Fragment() {
    ...
    private fun populatingData(){
        ...
        arrayList.add(cardItemWithoutId(1, R.drawable.s11, "All Sause", 2, 3))
        arrayList.add(cardItemWithoutId(2, R.drawable.s12, "Sause1", 2, 3))
        arrayList.add(cardItemWithoutId(3, R.drawable.s15, "Sause1", 2, 3))
        arrayList.add(cardItemWithoutId(4, R.drawable.s7, "Sause 3", 2, 3))
        arrayList.add(cardItemWithoutId(5, R.drawable.s2, "Sause4", 2, 3))
        arrayList.add(cardItemWithoutId(6, R.drawable.s7, "Sause 5", 2, 3))
        arrayList.add(cardItemWithoutId(6, R.drawable.s3, "Sause 6", 2, 3))
